...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bc}\;\Varid{bc})\mathrel{=}{}\<[26]%
\>[26]{}i_1\;(\Varid{bc}){}\<[E]%
\\
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataBlockchain}\;\Varid{f}\mathrel{=}{}\<[21]%
\>[21]{}\Varid{f}\comp \Varid{recBlockchain}\;(\Varid{cataBlockchain}\;\Varid{f})\comp \Varid{outBlockchain}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{allTransactions}\mathrel{=}(\Varid{cataBlockchain}\;\Varid{get\char95 transaction}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{get\char95 transaction}\mathrel{=}\alt{\p2\comp \p2}{\mathsf{conc}\comp ((\p2\comp \p2)\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}(\Varid{cataList}\;\Varid{h})\comp \Varid{col}\comp (\Varid{cataList}\;\Varid{g})\comp (\Varid{cataList}\;\Varid{f})\comp \Varid{allTransactions}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\alt{\Varid{nil}}{\Varid{cons}\comp ((\conj{\Varid{id}\times\Varid{negate}\comp \p2}{\p2}\comp (\Varid{id}\times\Varid{swap}))\times\Varid{id})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}\comp (\mathsf{conc}\comp ((\Varid{singl}\times\Varid{singl}))\times\Varid{id})}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\mathrel{=}\alt{\Varid{nil}}{\Varid{cons}\comp ((\Varid{id}\times\Varid{sum})\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\uncurry{(\equiv )}\comp (\length \times(\length \comp \Varid{nub}))\comp \Varid{dup}\comp \Varid{cataBlockchain}\;\Varid{f}{}\<[E]%
\\
\>[B]{}\hsindent{9}{}\<[9]%
\>[9]{}\mathbf{where}\;\Varid{f}\mathrel{=}\alt{\Varid{singl}\comp \p1}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{baseQTree}\;\Varid{g}\;\Varid{h}\mathrel{=}(\Varid{g}\times\Varid{id})+(\Varid{h}\times(\Varid{h}\times(\Varid{h}\times\Varid{h}))){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{cataQTree}\;\Varid{f}\mathrel{=}\Varid{f}\comp \Varid{recQTree}\;(\Varid{cataQTree}\;\Varid{f})\comp \Varid{outQTree}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{anaQTree}\;\Varid{f}\mathrel{=}{}\<[15]%
\>[15]{}\Varid{inQTree}\comp \Varid{recQTree}\;(\Varid{anaQTree}\;\Varid{f})\comp \Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathsf{fmap}\;\Varid{gen}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp \Varid{baseQTree}\;\Varid{gen}\;\Varid{id}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp \Varid{f})\mbox{\onelinecomment  inQTree para converter o either do cata para Qtree}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\Varid{g}+\Varid{h}{}\<[22]%
\>[22]{}\mbox{\onelinecomment  Co-produto para poder criar um either no fim}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\Varid{id}\times\Varid{swap}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\mathrel{=}\conj{\p1\comp \p2\comp \p2}{\Varid{s1}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{s1}\mathrel{=}\conj{\p1}{\Varid{s2}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{s2}\mathrel{=}\conj{\p2\comp \p2\comp \p2}{\p1\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\mathrel{=}\Varid{anaQTree}\;(\Varid{f}\comp \Varid{outQTree})\mbox{\onelinecomment  Out para converter a Qtree em either para a  função ana}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\Varid{g}+\Varid{id}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\Varid{id}\times((\Varid{i}\mathbin{*})\times(\Varid{i}\mathbin{*})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment USAMOS A PixelRGBA8 porque é o monade que é guardado no a da QTree}{}\<[E]%
\\
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{invert}\mbox{\onelinecomment  FMAP PARA APLICAR A FUNÇÃO A CADA UMA DAS FOLHAS}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{invert}\;(\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;(\Varid{a}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Criar um cata que faça a subtração do valor de k, para poder descer até onde se quer manter a arvore igual, depois disso fazer a prune da qtree, juntando as cells de maneira correspondente}{}\<[E]%
\\
\>[B]{}\Varid{compressQTree}\;\Varid{k}\;\Varid{qt}\mathrel{=}\Varid{cataQTree'}\;\Varid{f}\;(\Varid{depthQTree}\;\Varid{qt}\mathbin{-}\Varid{k})\;\Varid{qt}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\;\Varid{k}\mathrel{=}\Varid{p2p}\;(\Varid{id},\Varid{pruneQTree})\;(\Varid{k}\leq \mathrm{0})\comp \Varid{inQTree}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{cataQTree'}\;\Varid{f}\;\Varid{k}\mathrel{=}(\Varid{f}\;\Varid{k})\comp \Varid{recQTree}\;(\Varid{cataQTree'}\;\Varid{f}\;(\Varid{k}\mathbin{-}\mathrm{1}))\comp \Varid{outQTree}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{pruneQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{uncell}\comp \Varid{assocl}\comp \Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\mathrel{=}\alt{\Varid{id}}{\conj{\Varid{colorQTree}\comp \p1}{\Varid{addSizes}\comp \Varid{getSizes}}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{uncell}\mathrel{=}\uncurry{\cdot }\mathbin{\$}\uncurry{\Conid{Cell}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{addSizes}\;((\Varid{x1},\Varid{y1}),(\Varid{x2},\Varid{y2}))\mathrel{=}(\Varid{x1}\mathbin{+}\Varid{x2},\Varid{y1}\mathbin{+}\Varid{y2}){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{getSizes}\mathrel{=}\Varid{sizeQTree}\times(\Varid{sizeQTree}\comp \p2\comp \p2){}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{colorQTree}\mathrel{=}\Varid{cataQTree}\mathbin{\$}\alt{\p1}{\p1}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{convert}\mathbin{::}\Conid{QTree}\;\Conid{Bool}\to \Conid{Matrix}\;\Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{convert}\mathrel{=}\Varid{cataQTree}\;(\Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\alt{\Varid{g}}{\Varid{h}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\;(\Varid{c},(\Varid{i},\Varid{j}))\mathrel{=}\mathbf{if}\;(\Varid{c}\mathrel{\wedge}(\Varid{i}\geq \mathrm{3})\mathrel{\wedge}(\Varid{j}\geq \mathrm{3}))\;\mathbf{then}\;\Varid{line}\;\Varid{i}\;\Varid{j}\;\mathbf{else}\;matrix\;\Varid{j}\;\Varid{i}\;\underline{\Varid{c}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{h}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d})))\mathrel{=}(\Varid{a}{\,\updownarrow\,}\Varid{b}){\,\leftrightarrow\,}(\Varid{c}{\,\updownarrow\,}\Varid{d}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{line}\;\Varid{i}\;\Varid{j}\mathrel{=}((matrix\;\mathrm{1}\;\Varid{i}\;\Varid{true}){\,\leftrightarrow\,}((matrix\;(\Varid{j}\mathbin{-}\mathrm{2})\;\mathrm{1}\;\Varid{true}){\,\updownarrow\,}((matrix\;(\Varid{j}\mathbin{-}\mathrm{2})\;(\Varid{i}\mathbin{-}\mathrm{2})\;\Varid{false}){\,\updownarrow\,}(matrix\;(\Varid{j}\mathbin{-}\mathrm{2})\;\mathrm{1}\;\Varid{true})))){\,\leftrightarrow\,}(matrix\;\mathrm{1}\;\Varid{i}\;\Varid{true}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outlineQTree}\;\Varid{f}\mathrel{=}\Varid{convert}\comp \mathsf{fmap}\;\Varid{f}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\more
\ensuremath{\alt{\Varid{f}\;\Varid{k}\comp \mathrm{0}}{\Varid{f}\;\Varid{k}\comp \succ }\mathrel{=}\alt{\mathrm{1}\comp \Varid{id}}{\Varid{mul}\comp \conj{\Varid{l}\;\Varid{k}}{\Varid{f}\;\Varid{k}}}}

\just\equiv{Fusão-+ \{20\}, Absorção-+ \{22\}}
\more
\ensuremath{\Varid{f}\;\Varid{k}\comp \alt{\mathrm{0}}{\succ }\mathrel{=}\alt{\mathrm{1}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{lk}}{\Varid{fk}})}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{flatet}\mathbin{::}((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer}))\to (\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer}){}\<[E]%
\\
\>[B]{}\Varid{flatet}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{unflatet}\mathbin{::}(\Conid{Integer},\Conid{Integer},\Conid{Integer},\Conid{Integer})\to ((\Conid{Integer},\Conid{Integer}),(\Conid{Integer},\Conid{Integer})){}\<[E]%
\\
\>[B]{}\Varid{unflatet}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\mathrel{=}\Varid{flatet}\comp \conj{\Varid{f}}{\Varid{g}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\conj{\Varid{one}}{\succ }{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{g}\mathrel{=}\conj{\Varid{one}}{\Varid{one}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment loop (a,b,c,d) = (a*b , b+1 , c*d, d+1 ) }{}\<[E]%
\\
\>[B]{}\Varid{loop}\mathrel{=}\Varid{flatet}\comp \Varid{f}\comp \Varid{unflatet}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{f}\mathrel{=}\conj{\Varid{g}}{\Varid{h}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{g}\mathrel{=}\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{h}\mathrel{=}\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inFTree}\;(i_2\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Conid{Comp}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{cataFTree}\;\Varid{f}\mathrel{=}\Varid{f}\comp \Varid{recFTree}\;(\Varid{cataFTree}\;\Varid{f})\comp \Varid{outFTree}{}\<[E]%
\\
...
\>[18]{}\Varid{anaFTree}\;(\Varid{g}\comp \Varid{outNat}){}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{g}\mathrel{=}\underline{(\mathrm{1.0})}+\conj{((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow})\comp \succ }{\conj{\Varid{id}}{\Varid{id}}}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Dada uma cor constroi um bag com um berlinde dessa cor }{}\<[E]%
\\
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mbox{\onelinecomment  Multiplicação do monade}{}\<[E]%
\\
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concat}\comp (\map \;(\Varid{f})\comp \Varid{unB}\comp \mathsf{fmap}\;\Varid{unB}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\map \;(\Varid{id}\times(\mathbin{*}\Varid{b}))\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \Varid{f}\comp \conj{\Varid{id}}{\Varid{sum}\comp \map \;(\p2)}\comp \Varid{unB}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\;(\Varid{a},\Varid{b})\mathrel{=}\map \;(\lambda (\Varid{c},\Varid{d})\to (\Varid{c},\Varid{toFloat}\;\Varid{d}\mathbin{/}\Varid{toFloat}\;\Varid{b}))\;\Varid{a}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
