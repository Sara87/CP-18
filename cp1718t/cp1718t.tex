...
&
    \ensuremath{\Conid{Block}\mathbin{+}(\Conid{Block}\times\Conid{Blockchain})}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times}\cata{get\_transaction}}
\\
     \ensuremath{\Conid{Transactions}}
&
     \ensuremath{\Conid{Block}\mathbin{+}(\Conid{Block}\times\Conid{Transactions})}
           \ar[l]^-{\ensuremath{\Varid{get\char95 transaction}}}
}
\end{eqnarray*}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           ...
           \ar[r]^-{\ensuremath{\Varid{allTransactions}}}
&
    \ensuremath{\Conid{Transactions}}
          \ar[r]^-{\cata{f}}
&
    \ensuremath{((\Conid{Entity}\times\Conid{Value})\times(\Conid{Entity}\times\Conid{Value}))\mathbin{*}}
          \ar[d]^-{\cata{g}}
\\
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\Conid{MagicNumber}\mathbin{*}\times\Conid{MagicNumber}\mathbin{*}}
           \ar[d]_-{\ensuremath{\length \times(\length \comp \Varid{nub})}}
&
    \ensuremath{\Conid{BlockChain}}
          \ar[d]^-{\ensuremath{\Varid{isValidMagicNr}}}
          \ar[l]_-{\ensuremath{\Varid{dup}\comp }\cata{f}}
\\
    \ensuremath{\Conid{Int}\times\Conid{Int}}
          \ar[r]_-{\ensuremath{\uncurry{(\equiv )}}}
&
...
\column{9}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp \Varid{f}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{f}\mathrel{=}\Varid{g}+\Varid{h}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
...
\\
    \ensuremath{\Conid{QTree}}
          \ar[u]^-{\ensuremath{\Varid{scaleQTree}}}
          \ar[r]_-{\ensuremath{\Varid{f}\comp \Varid{outQTree}}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{QTree}\mathbin{\uparrow}\mathrm{4}}
          \ar[u]_-{\ensuremath{\Varid{id}\mathbin{+}}\ana{f.outQTree}}     
}
\end{eqnarray*}
...
&
    \ensuremath{\Conid{F}\;\Conid{QTree}}
           ...
           \ar[d]^-{\ensuremath{\Conid{F}\;\Varid{invert}}}
\\
    \ensuremath{\Conid{QTree}}
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{invert}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
...
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{line}\;\Varid{i}\;\Varid{j}\mathrel{=}((matrix\;\mathrm{1}\;\Varid{i}\;\Varid{true}){\,\leftrightarrow\,}((matrix\;(\Varid{j}\mathbin{-}\mathrm{2})\;\mathrm{1}\;\Varid{true}){\,\updownarrow\,}((matrix\;(\Varid{j}\mathbin{-}\mathrm{2})\;(\Varid{i}\mathbin{-}\mathrm{2})\;\Varid{false}){}\<[E]%
\\
\>[9]{}\hsindent{31}{}\<[40]%
\>[40]{}{\,\updownarrow\,}(matrix\;(\Varid{j}\mathbin{-}\mathrm{2})\;\mathrm{1}\;\Varid{true})))){}\<[E]%
\\
\>[9]{}\hsindent{2}{}\<[11]%
\>[11]{}{\,\leftrightarrow\,}(matrix\;\mathrm{1}\;\Varid{i}\;\Varid{true}){}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\mathit B\mathbin{+}(\Conid{A}\times\Conid{FTree})\mathbin{\uparrow}\mathrm{2}}
\\
    \ensuremath{\Conid{Int}}
          \ar[u]^-{\ensuremath{\Varid{generatePTree}}}
          \ar[r]_-{\ensuremath{\Varid{outNat}}}
&
...
\xymatrix@C=2cm{
    \ensuremath{\Varid{a}}
          ...
          \ar[r]^-{\ensuremath{\conj{\Varid{id}}{\mathrm{1}}}}
&
