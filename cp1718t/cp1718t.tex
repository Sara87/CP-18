...
\\[\blanklineskip]%
\>[B]{}\Varid{get\char95 transaction}\mathbin{::}\Conid{Block}+(\Conid{Block},\Conid{Transactions})\to \Conid{Transactions}{}\<[E]%
\\
\>[B]{}\Varid{get\char95 transaction}\mathrel{=}\alt{\p2\comp \p2}{\mathsf{conc}\comp ((\p2\comp \p2)\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\mathrel{=}(\Varid{cataBlockchain}\;\Varid{get\char95 transaction}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\onelinecomment (cataList h).col.(cataList g).}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin listMagic (Left b) = ([(p1 b)],[True])
listMagic (Right (b,(c,d))) = ([(p1 b)] ++ c,[not (elem (p1 b) c)] ++ d) \commentend}{}\<[E]%
\\[\blanklineskip]%
